...
This package provides **BitMart exchange plugin for bt_api** for the [bt_api](https://github.com/cloudQuant/bt_api_py) framework. It offers a unified interface for interacting with **BITMART** exchange.
...
| GitHub Repository | https://github.com/cloudQuant/bt_api_bitmart |
| Issue Tracker | https://github.com/cloudQuant/bt_api_bitmart/issues |
...
```
bt_api_bitmart/
├── src/bt_api_bitmart/     # Source code
...
- Report bugs via [GitHub Issues](https://github.com/cloudQuant/bt_api_bitmart/issues)
...
本包为 [bt_api](https://github.com/cloudQuant/bt_api_py) 框架提供 **BitMart exchange plugin for bt_api**。它提供了与 **BITMART** 交易所交互的统一接口。
...
| GitHub 仓库 | https://github.com/cloudQuant/bt_api_bitmart |
...
- 通过 [GitHub Issues](https://github.com/cloudQuant/bt_api_bitmart/issues) 反馈问题
